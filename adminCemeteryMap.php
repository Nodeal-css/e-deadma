...
<head>
	...
	<link rel="stylesheet" href="css/acm.css?v=<?php echo time(); ?>">
    ...
    <section class="dashboard">
        <div class="top">
            ...
            <div class="search-box">
                ...
                <i class="uil uil-search" onclick="searchGraveName();"></i>
            </div>
            <div>
                <p id="active-user"></p>
        ...
        <div class="dash-content">
            <div class="overview">
                ...
                <!-- Start of the Map -->
                <div class="mc w3-row w3-card-4 w3-container">
					<div class='w3-bar'>
						<button class="w3-button w3-bar-item w3-left w3-margin-top w3-animate-bottom" onclick="document.getElementById('modal-import-map').style.display='block'">Import map layout</button>
						<button class="w3-button w3-bar-item w3-left w3-margin-top w3-animate-bottom" onclick="checkVacantGrave();">Check vacant graves</button>
						<button class="w3-button w3-bar-item w3-left w3-margin-top w3-animate-bottom" onclick="location.reload();">Reload Map</button>
				...
				<div class="prop w3-row w3-padding-16">
					<div class="f w3-col s9">
						<table>
							<tr><td>Properties:</td><td></td><td></td><td></td></tr>
							<tr><td></td><td><br>Point A</td><td><br>Point B</td><td><br>Point C</td><td><br>Point D</td></tr>
							<tr><td><input type="hidden" name="tempX" id="tempX" readonly></td><td><label>X: </label><input type="text" name="x1" id="x1" readonly></td><td><label>X: </label><input type="text" name="x2" id="x2" readonly></td><td><label>X: </label><input type="text" name="x3" id="x3" readonly></td><td><label>X: </label><input type="text" name="x4" id="x4" readonly></td><td ></td><td><button class="sc w3-button w3-right" onclick="addCoordinates();">Save Coordinates</button></td></tr>
							<tr><td><input type="hidden" name="tempY" id="tempY" readonly></td><td><label>Y: </label><input type="text" name="y1" id="y1" readonly></td><td><label>Y: </label><input type="text" name="y2" id="y2" readonly></td><td><label>Y: </label><input type="text" name="y3" id="y3" readonly></td><td><label>Y: </label><input type="text" name="y4" id="y4" readonly></td><td ></td><td><button class="cls w3-button w3-right" onclick="clearCoordinates();">Clear</button></td></tr>
						</table>
					</div>
...
<div id="modal-import-map" class="imp w3-modal w3-animate-opacity">
	<div class="w3-modal-content">
		<span onclick="document.getElementById('modal-import-map').style.display='none'" class="w3-button w3-display-topright">&times;</span>
		<header class="w3-padding">
			<h2>Import Map Layout</h2>
		</header>
		<form id="upload-image-map">
			<div class="w3-center">
				<input type="file" name="upload-map" id="upload-map" accept=".jpg, .jpeg, .png">
			</div>
			<div class="ubtn w3-center">
				<button id="submit-map" class="w3-button">Upload</button>
			</div>
		</form>
	</div>
</div>
