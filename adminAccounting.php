...
<head>
    ...
    <!-- CSS  -->
    <link rel="stylesheet" href="css/accounting.css?v=<?php echo time(); ?>">
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <div class="overview">
                ...
                <div>
                    <div class="w3-card-2 w3-padding w3-round-xxlarge w3-row">
                        <div class="cad w3-col s3 w3-padding">
                            <label class="w3-right" for="transaction-id">Transaction:</label><br><br><br>
                            <label class="w3-right" for="ledger-expense-id">Ledger:</label><br><br><br>
                            <label class="w3-right" for="date-input">Date:</label><br><br><br>
                            <label class="w3-right" for="description-id">Description:</label><br><br><br><br>
                            <label class="w3-right" for="debit-id" id="label-debit">Debit:</label>
                            <label class="w3-right" for="credit-id" id="label-credit" style="display: none;">Credit:</label><br>
                        </div>:
                        <div class="cad1 w3-col s9 w3-padding">
                            ...
                            <input class="w3-input" type="number" id="debit-id" name="debit">                            
                            <input class="cred w3-input" type="number" id="credit-id" name="credit">
                            <br>
                            <button id="btn-expense" class="w3-button w3-round-xxlarge" onclick="addJournalExpense();">Save Expense</button>
                            <button id="btn-revenue" class="w3-button w3-round-xxlarge" onclick="addJournalRevenue();">Save Revenue</button>
                        </div>
                    </div>
                </div>
